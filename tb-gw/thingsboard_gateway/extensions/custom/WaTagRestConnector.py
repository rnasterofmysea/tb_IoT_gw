...
log = logging.getLogger("connector.custom")
...
class WaTagRestConnector(Connector, threading.Thread):
    def __init__(self, gateway, config, connector_type=None):
        ...
        self._config = config
        self._connector_type = connector_type or "custom"
        self._stopped = False
        ...
        try:
            converter_class = TBModuleLoader.import_module("custom", converter_info.get("extension", "WaTagRestConverter"))
